...
<html lang="en">
  <head>
    ...
    <title>Nandi Developers | Gallery</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">BROKER <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">                
            ...
            <div class="aa-gallery-content">
              <div class="aa-gallery-top">
                ...
                <ul>
                  ...
                  <li data-filter=".garage" class="filter">Bathroom</li>
                </ul>
              </div>
              <!-- Start gallery image -->
